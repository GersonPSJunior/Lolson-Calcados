 ...
 */
@Entity
@Table(name = "cliente", catalog = "turmacgrupo2", schema = "")
@NamedQueries({
    ...
    @NamedQuery(name = "Cliente.findByOrgaoEmissor", query = "SELECT c FROM Cliente c WHERE c.orgaoEmissor = :orgaoEmissor"),
...
public class Cliente implements Serializable {
    ...
    public String toString() {
        return "turmacgrupo2.Cliente[ idCliente=" + idCliente + " ]";
    }
